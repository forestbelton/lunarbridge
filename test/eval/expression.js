...
import { InterpretExprVisitor } from "../../dist/runtime/eval/expression.js";
...
describe("evaluating expressions", () => {
  ...
  describe("binary operations", () => {
    describe("addition", () => {
      ...
      it("number + metamethod", () => {
        ...
        tableRight.metatable = new LuaTable(new Map([["__add", (x, y) => y]]));
  ...
  describe("concatenation", () => {
    ...
    it("string .. string", () => {
      expect(
        visitor.visit(
          new BinOpExpr("..", new ConstantExpr("abc"), new ConstantExpr("def"))
        )
      ).to.equal("abcdef");
    });
